<%-- 
    ...
    Created on : 01/12/2020, 19:33:32
    Author     : Matheus
--%>
...
<html>
    ...
    <center>
        ...
        <form action="<c:url value="/RelatoriosClientes"/>" method="GET">
            ...
            <input name="cpf_cliente" maxlength="11" minlength="11" size="9" required="true"></input>
